...
class PairNet(object):
    ...
    def __init__(self, kernel=None, n_input=None, ground_truth_init=1, reg_scale=(0, 1), init_seed=(0, 1, 2), device_config=['/device:GPU:0']):
        """
...
class TripNet(PairNet):
    ...
    def __init__(self, kernel=None, n_input=None, ground_truth_init=1, reg_scale=(1, 1, 1, 1), len_scale=21, dataset_num=4,
        ...
        super(TripNet, self).__init__(kernel=kernel, n_input=n_input, ground_truth_init=ground_truth_init,
                                      reg_scale=reg_scale, init_seed=init_seed, device_config=['/device:GPU:0'])
        """
        Create and build the PairNet
        :param kernel: Kernel object
        :param n_input: input dimension
